  ...
  const mockT = (key: string, params?: Record<string, string>) => {
    ...
    try {
      const translations: Record<string, string> = {
        ...
        "disabled_app_affects_event_type": "The app {appName} has been disabled for event type {eventType}",
        "payment_disabled_still_able_to_book": "Payment has been disabled but booking is still available",
        "app_disabled_with_event_type": "The app {appName} has been disabled for event type {title}",
