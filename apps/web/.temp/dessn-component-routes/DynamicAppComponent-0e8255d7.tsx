...
export default function ComponentPreview() {
  ...
  const setAttributeRoutingConfig = (id: string, attributeRoutingConfig: Partial<{ salesforce?: { rrSkipToAccountLookupField?: boolean; rrSKipToAccountLookupFieldName?: string; }; skipContactOwner?: boolean; }>) => {
